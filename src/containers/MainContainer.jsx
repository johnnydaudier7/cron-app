  ...
  const onLoadMonthly = (formattedExpression) => {
    try {
      setMonthlyData({
        selectedMinute: formattedExpression.selectedMinute,
        selectedHour: formattedExpression.selectedHour,
        selectedDays: formattedExpression.selectedMonthDays.map((d) =>
          String(d)
        ),
      });
  ...
  return (
    <>
      ...
      <Routes>
        <Route
          path="/"
          element={<Daily dailyData={dailyData} setDailyData={setDailyData} />}
        />
        <Route
          path="/daily"
          element={<Daily dailyData={dailyData} setDailyData={setDailyData} />}
        ...
        <Route
          path="/weekly"
          element={
            <Weekly weeklyData={weeklyData} setWeeklyData={setWeeklyData} />
          }
        />
        <Route
          path="/monthly"
        ...
        <Route
          path="custom"
          element={
            <Custom customData={customData} setCustomData={setCustomData} />
          }
        />
        <Route
          path="/*"
